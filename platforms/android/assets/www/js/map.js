...
{	
	...
	var phoneVal = $('#usrtel').val();
	var emailVal = $('#locEmail').val();
	...
	var userImage = document.getElementById('novaSlika');
	var imgData= getBase64Image(userImage);
	//var base64_data = getBase64Image("#novaSlika");//new Buffer(fs.readFileSync('imageSrc')).toString('base64');
...
$('#btnSearch').click(function()
 { 
  ...
  socket.on('locationsReturn',function(locationsReturn)
     {
      alert("Places near by: "+locationsReturn)
     });
